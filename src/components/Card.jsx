  ...
  return (
    <div className='h-auto lg:h-[800px] xl:h-auto w-full flex flex-col lg:flex-col items-center justify-between lg:gap-20 border-b-card lg:border-none'>
      <a
        href={link}
        ref={cardRef}
        className={`relative w-[200px] lg:w-full h-[450px] bg-cover bg-center md:transition-transform md:duration-300 ${isHovered && isVisible ? 'scale-110' : ''} focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-blue-500`}
